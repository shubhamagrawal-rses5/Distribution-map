export const CountryFormatedData = [
    ["Country", "Posts"],
  ];
const countryData = [
...
countryData.forEach((element)=>{
       CountryFormatedData.push([element.c[0].v,element.c[1].v ])
})
//-------------------------------------------------------------------


export const SubCountryINDIAFormatedData = [
  ["State", "Posts"],
];
const subCountryINDIAData = [
    {
        "c": [
            {
                "v": "Maharashtra"
...
subCountryINDIAData.forEach((element)=>{
    SubCountryINDIAFormatedData.push([element.c[0].v,element.c[1].v ])
})
//-------------------------------------------------------------------


export const SubCountryUSAFormatedData = [
    ["State", "Posts"],
  ];
  const subCountryUSAData = [
    {
        "c": [
            {
                "v": "California"
  ...
  subCountryUSAData.forEach((element)=>{
      SubCountryUSAFormatedData.push([element.c[0].v,element.c[1].v ])
  })
//-------------------------------------------------------------------
